...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<h4> <?php echo "<img src='". $row['image']."' height='130' width='130'>" ?></h4>
				...
				<table class="table">
					...
					<?php
						...
						while ($row = mysqli_fetch_assoc($result))
						{
							...
							echo "<td>". $count . "</td>";
							echo "<td>". $row['name'] . "</td>";
							echo "<td><input type='number' class='form-control' onkeyup='calculatemarks();' id='mark" . $count . "' name='mark" . $count . "' value='" . $row['mark']  . "' required/>
